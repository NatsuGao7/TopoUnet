...
def main(args):
    ...
    params_to_optimize = []
    params_to_optimize.extend([p for p in model.parameters() if p.requires_grad])  # Model parameters
    params_to_optimize.extend([p for p in pi_model.parameters() if p.requires_grad])  # pi_model parameters
