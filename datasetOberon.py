...
class OberonDataset(Dataset):
    def __init__(self, root: str, train: bool, val: bool = False, test: bool = False, transforms=None):
        super(OberonDataset, self).__init__()
        ...
        # Data root path
        data_root = os.path.join(root, "Oberon", self.flag)
        ...
        self.PI = [os.path.join(data_root,"PI",i.split('.')[0]+'.mat') for i in img_names]
